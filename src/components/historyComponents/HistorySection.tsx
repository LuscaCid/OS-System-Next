...
export function HistorySection () {
    ...
    return(
        <div className="h-full col-span-1 md:col-span-4/5 w-full  border-r border-zinc-300 relative">
                <h1 className="mb-2 flex items-center gap-2 p-2 text-3xl font-bold border-b border-zinc-300 w-full p">
                ...
                <section className=" border-t  border-b border-zinc-300 rounded-md m-2 flex flex-col gap-2 overflow-y-auto absolute inset-0 top-14 bottom-4 pr-2">
                    <HistoryBox 
