        ...
        <section className=' absolute inset-0 top-14  m-2'>
            <FormProvider {...newJobForm}>
                ...
                <form className='h-full border border-zinc-300 rounded-md w-full py-4 px-2 shadow-lg flex flex-col gap-2'>
                    ...
                    <button 
                        className='flex items-center justify-center bg-transparent text-zinc-950 rounded-md p-2 hover:bg-zinc-950 transition duration-200 border border-zinc-300 hover:text-zinc-100 shadow-lg'
                        type='submit'>
